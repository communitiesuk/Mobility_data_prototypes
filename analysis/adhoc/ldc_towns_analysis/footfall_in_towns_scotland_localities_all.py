...
BUAs_filter = BUAs[BUAs.name.isin(bua_filter.name)]
...
BUA_footfall = BUA_footfall.merge(bua_filter[['name', 'Population']])

BUA_footfall.to_csv("Q:/SDU/Mobility/Data/Processed/LDC_Density/Towns/all_towns/all_towns_O2_footfall_Scotland.csv", index=False)
