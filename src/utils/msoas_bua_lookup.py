...
if GET_MSOA_BUA_LOOKUP or GET_LSOA_BUA_LOOKUP:
    ...
    if GET_MSOA_BUA_LOOKUP:
        ...
        bua_by_msoa_to_store.sort_values('BUA22CD').to_csv("Q:/SDU/Mobility/Data/Processed/MSOA_to_BUA_lookup.csv", index=False)

    if GET_LSOA_BUA_LOOKUP:
        
        lsoas=get_all_tiny_areas()
        
        bua_by_lsoa = gpd.overlay(BUAs, lsoas)
        ...
        bua_by_lsoa_to_store.sort_values('BUA22CD').to_csv("Q:/SDU/Mobility/Data/Processed/LSOA_to_BUA_lookup.csv", index=False)
